...
bool mongory_array_push(mongory_array *self, mongory_memory_pool *pool, mongory_value *value) {
  return mongory_iterable_push((mongory_iterable *)self->base, pool, value);
}
...
bool mongory_array_set(mongory_array *self, mongory_memory_pool *pool, size_t index, mongory_value *value) {
  return mongory_iterable_set((mongory_iterable *)self->base, pool, index, value);
}
