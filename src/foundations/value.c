...
static inline int mongory_value_unknown_compare(mongory_value *a,
                                                mongory_value *b) {
  (void)a;
  (void)b;
  return mongory_value_compare_fail;
...
static inline int mongory_value_regex_compare(mongory_value *a,
                                              mongory_value *b) {
  (void)a;
  (void)b;
  return mongory_value_compare_fail;
...
static inline int mongory_value_ptr_compare(mongory_value *a,
                                            mongory_value *b) {
  (void)a;
  (void)b;
  return mongory_value_compare_fail;
