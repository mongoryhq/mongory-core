...
static inline bool mongory_matcher_inclusion_value_compare(mongory_value *a,
                                                           void *ctx) {
  mongory_matcher_inclusion_context *context =
      (mongory_matcher_inclusion_context *)ctx;
...
static inline bool mongory_matcher_inclusion_array_compare(mongory_value *a,
                                                           void *ctx) {
  mongory_matcher_inclusion_context *context =
      (mongory_matcher_inclusion_context *)ctx;
  ...
  bool is_continue =
      b->each(b, &ctx_b, mongory_matcher_inclusion_value_compare);
