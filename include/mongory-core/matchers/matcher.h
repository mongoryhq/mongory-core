...
typedef bool (*mongory_matcher_match_func)(
    struct mongory_matcher *matcher, mongory_value *value); // match function
...
mongory_matcher *
mongory_matcher_new(mongory_memory_pool *pool,
                    mongory_value *condition); // create new matcher
